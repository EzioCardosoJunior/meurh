                ...
                items: [
                    {
                        ...
                        routerLink: ['/identidadeusr']
                    },
                    {
                        label: 'Endereço',
                        icon: 'pi pi-fw pi-map-marker',
                        routerLink: ['/enderecousr']
                    },
                    {
                        label: 'Origem',
                        icon: 'pi pi-fw pi-map',
                        routerLink: ['/origemusr']
                    }
                ]
            },
            {
                ...
                items: [
                    {
                        ...
                        routerLink: ['/ultimoemprego']
                    },
                    {
                        label: 'Empregos Anteriores',
                        icon: 'pi pi-fw pi-directions-alt',
                        routerLink: ['/empregosanteriores']
                    },
                    {
                        label: 'Outras Atividades',
                        icon: 'pi pi-fw pi-file',
                        routerLink: ['/outrasatividades']
                    }
                ]
            },
            {
                label: 'Formação e Conhecimentos',
                icon: 'pi pi-users',
                items: [
                    {
                        label: 'Fundamental e médio',
                        icon: 'pi pi-fw pi-book',
                        routerLink: ['/fundamentalemedio']
                    },
                    {
                        label: 'Graduação e Técnico',
                        icon: 'pi pi-fw pi-file-edit',
                        routerLink: ['/graduacaoetecnico']
                    },
                    {
                        label: 'Pós-Graduação',
                        icon: 'pi pi-fw pi-file-edit',
                        routerLink: ['/posgraduacao']
                    },
                    {
                        label: 'Outros Cursos',
                        icon: 'pi pi-fw pi-ellipsis-h',
                        routerLink: ['/outroscursos']
                    },
                ]
            },
            {
